...
等价命令行：
    uvicorn semantic_cache.main:app --host 127.0.0.1 --port 8000
"""
...
# 各服务在 main.py 末尾暴露模块级 app = create_app()（此处为 semantic_cache/main.py）
APP_IMPORT = "semantic_cache.main:app"
